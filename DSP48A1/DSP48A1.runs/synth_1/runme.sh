...
HD_PWD='F:/Electronics/Digital Electronics - KW/Mini_project_DSP48A1/DSP48A1/DSP48A1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DSP48A1Module.tcl
