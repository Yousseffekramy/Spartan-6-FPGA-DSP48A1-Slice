...
HD_PWD='F:/Electronics/Digital Electronics - KW/Mini_project_DSP48A1/DSP48A1/DSP48A1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DSP48A1Module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DSP48A1Module.tcl -notrace
